...
<head>
<meta charset="utf-8" />
<title>Home of Rest - 后台管理系统 - 留言查看</title>
                        ...
                        <div class="portlet box blue tabbable">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="hidden-480">留言查看</span>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <form action="" class="form-horizontal">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <span class="help-inline"><?php echo $data['name']; ?></span>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">邮箱</label>
                                                <div class="controls">
                                                    <span class="help-inline"><?php echo $data['email']; ?></span>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">电话</label>
                                                <div class="controls">
                                                    <span class="help-inline"><?php echo $data['telephone']; ?></span>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">客户IP</label>
                                                <div class="controls">
                                                    <span class="help-inline"><?php echo $data['ip']; ?></span>
                                                </div>
                                            </div>
                                            <div class="control-group">
