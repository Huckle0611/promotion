...
<head>
<meta charset="utf-8" />
<title>Home of Rest - 后台管理系统 - 数据列表</title>
...
<body class="page-header-fixed">
                    ...
                    <div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-table"></i>数据列表</div>
                                <div class="actions">
                                    <a href="javascript:;" class="btn red delallbtn" tname="<?php echo $tname; ?>">
                                        <i class="icon-remove"></i> 批量删除</a>
                                    <a href="/admin.php/data/add?tname=<?php echo $tname; ?>" class="btn green"><i class="icon-plus"></i> 添加</a>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="/admin.php/data/look?tname=<?php echo $tname; ?>&infoid=<?php echo $v['id']; ?>" class="label btn green">查看</a>&nbsp;&nbsp;
                                                <a href="/admin.php/data/edit?tname=<?php echo $tname; ?>&infoid=<?php echo $v['id']; ?>" class="label btn blue">编辑</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
    ...
    $(function(){
        $('a.delallbtn').click(function(){            
            ...
            $.ajax({
                type: "POST",
                url: "/admin.php/data/delalldata",
                data: "imgs="+spCodesTemp+"&tname="+tname,
                dataType: "json",
